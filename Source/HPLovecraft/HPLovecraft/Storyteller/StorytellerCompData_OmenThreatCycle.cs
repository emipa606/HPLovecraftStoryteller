...
namespace HPLovecraft
{
    ...
    public class StorytellerData : IExposable
    {
        ...
        {
            Scribe_Values.Look(ref this.standardEvents, "standardEvents", 0);
            Scribe_Values.Look(ref this.cosmicHorrorEvents, "cosmicHorrorEvents", 0);
            Scribe_Values.Look(ref this.lastEventWasOmen, "lastEventWasOmen");
        }
    }
}
